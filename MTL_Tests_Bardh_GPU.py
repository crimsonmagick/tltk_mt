...
n = 0
N = 1000000
range_list = [10,100,1000,10000,100000]
cpu_duration = []
gpu_duration = []
Aspeed = -1
bspeed = -120
...
#     root = Not(And(Finally(0,100,speed_pred,False), Finally(0,100,rpm_pred,False)))
...
#     t0 = time.time()
#     print(len(root.eval_interval(traces,time_stamps)))
#     t1 = time.time()

...
traces = {'speed': np.array([20,20,52,63,64,65,66],dtype=np.float64), 'rpm':np.array([1020,2022,3022,2523,4024,4025,4026],dtype=np.float64)}
...
t0 = time.time()
print(r1.eval_interval(traces, time_stamps))
t1 = time.time()

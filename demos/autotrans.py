...
import pytaliro.pytaliro as pytaliro
import pytaliro.robustness.MTL_GPU as MTL
...
results = pytaliro.falsify(model, step, inp_range, simulation_time, interpolation, cp_samples, predicates, root)
